...
public:
    ...
    void adjacent(dijkstra<int, string, int>::yield& yield, const int& from) {
...
BOOST_AUTO_TEST_CASE(classic_graph_dijkstra) {
    classic_graph g;
    dijkstra<int, string, int> ah(&g, &classic_graph::adjacent);
...
public:
    ...
    void adjacent(dijkstra<point, char, double, double>::yield& yield, const point& p) {
...
BOOST_AUTO_TEST_CASE(generated_graph_dijkstra, *boost::unit_test::tolerance(0.000001)) {
	generated_graph g;
	dijkstra<point, char, double, double> ah(&g, &generated_graph::adjacent, &generated_graph::is_final);
